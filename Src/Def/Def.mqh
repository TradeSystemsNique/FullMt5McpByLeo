...
enum ENUM_MCPFUNC_TESTER_GET
 {
  MCPFUNC_TESTER_GET_SUMMARY,
  MCPFUNC_TESTER_GET_BALANCE_HISTORY,
  MCPFUNC_TESTER_GET_EQUITY_HISTORY,
  MCPFUNC_TESTER_GET_DEALS_HISTORY
 };

enum ENUM_MCPFUNC_CALCORDER
 {
  MCPFUNC_CALCORDER_CALCULATE_SL_WITH_LOT,
  MCPFUNC_CALCORDER_MONEY_TO_POINTS,
  MCPFUNC_CALCORDER_GET_LOTE_BY_RISK_MONEY_AND_SL_POINTS,
  MCPFUNC_CALCORDER_GET_MAX_LOTE_TO_TRADE,
  MCPFUNC_CALCORDER_GET_LOTE_BY_ONLY_RISK_MONEY,
 };
